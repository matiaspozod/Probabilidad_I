...
> "Es la cantidad que se está dispuesto a pagar en una apuesta
> que paga $1"
...
:::{.callout-important title='Axiomas de Probabilidad de Kolmogorov Smirnov (1933)'}
1. **No negatividad:** La probabilidad de cualquier suceso $A$ es no negativa: $P(A) \geq 0$  

2. **Certeza:** La probabilidad del espacio muestral (suceso seguro) es 1: $P(S) = 1$  

3. **Aditividad o $\sigma-aditividad$:** Para sucesos mutuamente excluyentes, la probabilidad de su unión es la suma de sus probabilidades: $P(A \cup B) = P(A) + P(B)$   
:::